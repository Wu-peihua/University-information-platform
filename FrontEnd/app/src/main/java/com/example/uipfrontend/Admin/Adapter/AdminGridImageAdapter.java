 ...
 * data：16/7/27
 */
public class AdminGridImageAdapter extends
        RecyclerView.Adapter<AdminGridImageAdapter.ViewHolder> {
    ...
    public AdminGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
