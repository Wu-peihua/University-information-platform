...
INSERT INTO `user_info`(`user_id`, `user_name`, `pw`, `stu_number`, `stu_card`, `portrait`, `university_id`, `institute_id`, `user_type`, `created`) VALUES (5, '大熊', '123456', NULL, NULL, 'http://img1.imgtn.bdimg.com/it/u=2156833431,1671740038&fm=26&gp=0.jpg', NULL, NULL, 2, '2020-04-27 23:26:37');
INSERT INTO `user_info`(`user_id`, `user_name`, `pw`, `stu_number`, `stu_card`, `portrait`, `university_id`, `institute_id`, `user_type`, `created`) VALUES (6, '丸子', '123456', NULL, NULL, 'http://img2.imgtn.bdimg.com/it/u=2421351453,1852348871&fm=26&gp=0.jpg', NULL, NULL, 2, '2020-04-27 23:26:37');
...
CREATE TABLE `operation_record` (
  ...
  `type` int(2) NOT NULL,          #1-帖子，2-评论，3-回复，4-组队信息，5-课程评论，6-资源
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`info_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `operation_record_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `uip`.`courses` (`user_id`, `university_id`, `institute_id`, `course_name`, `teacher_name`, `course_picture`, `info_date`, `description`, `average_score`) VALUES ('1', '1', '12', '计算机网络', '唐华', 'https://image.slidesharecdn.com/itpresentation-160222172239/95/computer-networks-presentation-2-638.jpg?cb=1456162084
', '2020-4-28 12:12:23', '打开互联网的世界', '0');
INSERT INTO `uip`.`courses` (`user_id`, `university_id`, `institute_id`, `course_name`, `teacher_name`, `course_picture`, `info_date`, `description`, `average_score`) VALUES ('1', '1', '12', '操作系统', '李丁丁', 'https://image.slidesharecdn.com/os-161215152621/95/overview-of-various-types-of-operating-system-1-638.jpg?cb=1481816137
', '2020-4-28 12:12:24', '熟悉操作系统基本原理', '0');
INSERT INTO `uip`.`courses` (`user_id`, `university_id`, `institute_id`, `course_name`, `teacher_name`, `course_picture`, `info_date`, `description`, `average_score`) VALUES ('1', '1', '12', '编译原理', '黄煜廉', 'http://www.mastergradeit.co.za/images/courses/programming/Introduction-to-Programming-courses-capetown-mastergrade-it.png', '2020-4-28 12:12:25', '编译原理基础', '0');
INSERT INTO `uip`.`courses` (`user_id`, `university_id`, `institute_id`, `course_name`, `teacher_name`, `course_picture`, `info_date`, `description`, `average_score`) VALUES ('1', '1', '12', 'Linux', '李丁丁', 'http://www.mastergradeit.co.za/images/courses/programming/Introduction-to-Programming-courses-capetown-mastergrade-it.png', '2020-4-28 12:12:25', 'Linux实战', '0');
INSERT INTO `uip`.`courses` (`user_id`, `university_id`, `institute_id`, `course_name`, `teacher_name`, `course_picture`, `info_date`, `description`, `average_score`) VALUES ('1', '1', '12', '数据结构', '李晶晶', 'http://www.mastergradeit.co.za/images/courses/programming/Introduction-to-Programming-courses-capetown-mastergrade-it.png', '2020-4-28 12:12:25', '数据结构基础', '0');
